...
function setList (){
    ...
    if(members.length<1){
        ...
        for(var i=0; i<members.length; i++){
            ...
            tbody += '  <td><a href="javascript:editMember('+i+')">수정</a> | <a href="javascript:deleteMember('+i+')">삭제</a></td>'; //해당하는 index값이 호출하는 함수의 매개 변수 인자로 쓰인다.
            tbody += '</tr>';
        }
    }
